  ...
  <div className="app__footer section__padding" id="login">
    ...
    <div className="app__footer-links">
      <div className="app__footer-links_contact">
        ...
        <p className="p__opensans">Tbilisi Paliashvili 28 ST</p>
        <p className="p__opensans">+995 592 007 012</p>
      </div>
    ...
    <div className="footer__copyright">
      <p className="p__opensans">2021 Churchuli. All Rights reserved.</p>
    </div>
